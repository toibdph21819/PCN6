<div class="bg-white p-5 min-h-[100vh] flex items-center">
  <form name="form" onsubmit="return validate()" class="w-full  mx-auto p-5 rounded-md  border" enctype="multipart/form-data" action="index.php?insert" method="post">
    ...
    <div class="flex flex-wrap -mx-3 mb-6">
      <div class="w-full px-3">
        ...
        <input value="<?= $get_id ?>" class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="name" type="text" name="product_id" placeholder="">
    ...
    <div class="flex flex-wrap -mx-3 mb-6 space-x-3">
      ...
      <div class="form-check space-x-1">
        ...
        <p class="text-red-500 text-xs italic"><?= $err['featured'] ?? '' ?></p>
    ...
    <div class="flex flex-wrap -mx-3 mb-6">
      <div class="w-full px-3">
        ...
        <div class="relative">
          <?php if (count($rows_types) == 0) : ?>
            <h3 class="text-xl">Không có dữ liệu</h3>
          <?php else : ?>
            <select name="type_id[]" multiple class="block appearance-none w-full bg-gray-200 border border-gray-200 text-gray-700 py-3 px-4 pr-8 rounded leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="grid-state">
        ...
        <p class="text-gray-600 text-xs italic">có thể chọn nhiều ok</p>
    ...
    <div class="flex flex-wrap -mx-3 mb-2">
      <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
        ...
        <input class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="" type="number" name="price" placeholder="">
      </div>
      <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
        <label class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2" for="grid-state">
          mã
