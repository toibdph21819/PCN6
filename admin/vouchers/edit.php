<div class="bg-white p-5 min-h-[100vh] flex items-center">
  <form name="form" class="w-full  mx-auto p-5 rounded-md  border" enctype="multipart/form-data" action="index.php?edit&id=<?= $get_id ?>" method="post">
    ...
    <div class="flex flex-wrap -mx-3 mb-6">
      <div class="w-full px-3">
        ...
        <input value="<?= $row['discount'] ?? "" ?>" class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="discount" type="number" step="0.1" name="discount" placeholder="">
        <p class="text-gray-600 text-xs italic">Tuỳ bạn đặt như nào thì đặt</p>
    ...
    <div class="flex flex-wrap -mx-3 mb-6">
      <div class="w-full px-3">
        ...
        <input value="<?= $row['due'] ?? "" ?>" class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="" type="datetime-local" step="0.1" name="due" placeholder="">
        <p class="text-gray-600 text-xs italic">Tuỳ bạn đặt như nào thì đặt</p>
